...
export async function GET(
    ...
    try {
        ...
        page.drawText(
            `Generated by UtilSign • ${new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit', hour12: true })}`,
